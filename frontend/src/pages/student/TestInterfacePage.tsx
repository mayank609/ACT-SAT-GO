      ...
      {showSectionDirections && (
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
            ...
            {/* Body */}
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-3 text-sm text-gray-700 leading-relaxed">
              {isMath ? (
                <>
                ...
                <>
                  ...
                  <p>All questions in this section are <strong>multiple-choice</strong> with four answer choices. Each question has a single best answer.</p>
                </>
              )}
              <p className="text-gray-500 text-xs pt-1">You can cross out answers you think are wrong using the cross-out tool to the right of each choice, and mark a question for review to return to it later.</p>
            </div>
            {/* Footer */}
            <div className="px-6 py-4 border-t border-gray-100 bg-gray-50 flex justify-end">
              <button
                onClick={() => setShowSectionDirections(false)}
                className="px-8 py-2.5 bg-[#1b3d6e] hover:bg-[#15305a] text-white text-sm font-bold rounded-lg transition-colors"
              >
                Continue
              </button>
            </div>
